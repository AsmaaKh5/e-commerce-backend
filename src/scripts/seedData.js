    ...
    const products = await Product.insertMany([
      {
        ...
        images: ['https://via.placeholder.com/300?text=iPhone+15+Pro'],
        stock: 50,
        ratingsAverage: 4.8,
        ratingsQuantity: 245,
      },
      {
        ...
        brand: brands[1]._id,
        category: categories[1]._id,
        images: ['https://via.placeholder.com/300?text=Samsung+Galaxy+S24'],
        stock: 45,
        ratingsAverage: 4.6,
        ratingsQuantity: 189,
      },
      ...
      },
      {
        ...
        images: ['https://via.placeholder.com/300?text=LG+Monitor'],
        stock: 15,
        ratingsAverage: 4.5,
        ratingsQuantity: 87,
      },
      {
        ...
        brand: brands[0]._id,
        category: categories[3]._id,
        images: ['https://via.placeholder.com/300?text=Apple+Watch'],
        stock: 60,
        ratingsAverage: 4.6,
        ratingsQuantity: 198,
      },
